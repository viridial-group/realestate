...
/**
 * Configuration Kafka commune pour tous les services.
 * Cette configuration est activée uniquement si la propriété spring.kafka.bootstrap-servers est définie.
 */
@Configuration
...
public class KafkaConfig {
    ...
    @Value("${spring.kafka.consumer.group-id:realestate-group}")
